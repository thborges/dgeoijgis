...
//#define DATASET_PAGE_SIZE 8192
#define DATASET_CACHE_MAX 2
...
void             dataset_store_to_disk(dataset *ds, char *file_name);
dataset*         dataset_load_from_disk(char *name, char *file_name);
